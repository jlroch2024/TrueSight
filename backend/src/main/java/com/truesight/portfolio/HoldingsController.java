...
public class HoldingsController {
    ...
    @GetMapping("/holdings")
    @Operation(summary = "Show portfolio holdings and annual report status")
    public List<AnalysisService.HoldingView> holdings(@PathVariable Long portfolioId) {
        return analysis.getHoldings(portfolioId);
    }
}
